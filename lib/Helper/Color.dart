...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffB21919);
  //Color(0xffFC6A57);
  static const Color secondary = Color(0xffB21919);
  // Color(0xffFDC994);
  ...
  static const Color grad1Color = Color(0xffB21919);
  // Color(0xffFFBD69);
  static const Color grad2Color = Color(0xffB21919);
  // Color(0xffFF6363);
