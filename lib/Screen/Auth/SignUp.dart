        ...
        (value) => context.read<AuthenticationProvider>().getSingUPData().then(
          (
            ...
            if (!error!) {
              ...
              //   ),
              // );
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> SendOtp()));
                  // getTranslated(context, 'REGISTER_SUCCESS_MSG')!
              ...
              Expanded(
                ...
                child: TextFormField(
                    onSaved: (String? value) {
                              ...
                              onFieldSubmitted: (v) {
                                _fieldFocusChange(context, nameFocus!, nameFocus);
                              },
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              const Padding(
                padding:  EdgeInsets.only(left: 8.0),
                child: Icon(Icons.email, color: colors.primary,),
              ),
              Expanded(
                flex: 4,
                child: TextFormField(
